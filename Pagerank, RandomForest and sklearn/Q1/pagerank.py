...
"""
def author():
        return 'szhao326' # replace sroutray3 with your Georgia Tech username.

def gtid():
    return 903517007 # replace with your GT ID number
...
#############################################
            ...
            new_scores = new_scores+(1-damping_factor)*node_weights
            scores = new_scores
